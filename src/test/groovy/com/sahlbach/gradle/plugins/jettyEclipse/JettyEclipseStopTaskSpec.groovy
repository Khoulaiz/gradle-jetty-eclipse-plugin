...
class JettyEclipseStopTaskSpec extends Specification {

    def "Creates new custom JettyEclipseStop task"() {
        setup:
        ...
        when:
            JettyEclipseStop task = project.tasks.create('customStop', JettyEclipseStop)
