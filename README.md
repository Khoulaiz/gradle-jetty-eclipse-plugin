...
| automaticReload          | boolean       | false         | true: the webapp is reloaded after changes were detected <br/>false: changes are reported to console, reload must be triggered manually via the console
